...
def main():
    ...
    check(all(text in main_source for text in ("Canonical Accounting is", "Opening Snapshot evidence", "Evidence Coverage is", "Buying Power is", "Risk Approval", "Monitor Mode")),
